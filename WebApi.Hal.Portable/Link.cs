...
// 
// 	WebApi.Hal, Link.cs
// 	Copyright © Team Knowledge LTD 2013
// 
// ********************************************************************************
...
namespace WebApi.Hal
{
    ...
    public class Link
    {
        ...
        public Link(string rel, string href)
        {
            ...
            Href = href;
            if (href != null)
                IsTemplated = Regex.Match(href, @"{\w+}", RegexOptions.CultureInvariant).Success;
        }
        ...
        public Uri CreateUri(params Func<string, object>[] substitutions)
        {
            ...
            foreach (var substitution in substitutions)
            {
                ...
                var substituionValue = value == null ? null : Uri.EscapeUriString(value.ToString());
